...
module.exports = [
    body("first_name").notEmpty().withMessage("Por favor escriba su nombre"),
    body("last_name").notEmpty().withMessage("Por favor escriba su apellido"),
    body("email").notEmpty().withMessage("Por favor escriba su correo electrónico").bail()
        ...
        ,
    body("password").notEmpty().withMessage("Por favor escriba su contraseña"),
